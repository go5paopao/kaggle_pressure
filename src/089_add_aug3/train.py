...
def run():
    ...
    train_aug_df1 = pd.read_csv(INPUT_DIR / "ventilator-pressure-prediction/train_aug1.csv")
    train_aug_df2 = pd.read_csv(INPUT_DIR / "ventilator-pressure-prediction/train_aug2.csv")
    train_aug_df3 = pd.read_csv(INPUT_DIR / "ventilator-pressure-prediction/train_aug3.csv")
    train_aug_df1["u_in"] = train_aug_df1["u_in"].clip(0)
    train_aug_df2["u_in"] = train_aug_df2["u_in"].clip(0)
    train_aug_df3["u_in"] = train_aug_df3["u_in"].clip(0)
    ...
    train_aug_df1 = make_feature(train_aug_df1)
    train_aug_df2 = make_feature(train_aug_df2)
    train_aug_df3 = make_feature(train_aug_df3)
    test_df = make_feature(test_df)

    train_df["breath_id_ix"] = 0
    train_aug_df1["breath_id_ix"] = 1
    train_aug_df2["breath_id_ix"] = 2
    train_aug_df3["breath_id_ix"] = 3
    train_df = pd.concat([
        train_df, train_aug_df1, train_aug_df2, train_aug_df3
